...
const skillsData = [
  ...
  { name: 'RAG Pipelines', level: 'high', value: 9, category: 'ai' },
  { name: 'n8n', level: 'high', value: 8, category: 'ai' },
  { name: 'MCP Servers', level: 'high', value: 8, category: 'ai' },
  { name: 'Vector Search', level: 'high', value: 8, category: 'ai' },
  ...
  { name: 'gRPC', level: 'high', value: 9, category: 'backend' },
  ...
  { name: 'Kubernetes', level: 'mid', value: 7, category: 'devops' },
  { name: 'SQS', level: 'mid', value: 6, category: 'devops' },
